...
🏗️ Tech Stack:-
---
- Frontend:- Next.js (App Router), React, Axios, Tailwind CSS, Dark Theme UI, Deployed on Vercel.
- Backend:- Java Spring Boot, Spring Data JPA, REST APIs, Token validation logic, Deployed on Render.
- Database:- PostgreSQL, Hosted on Render, Production-ready schema
...
---
Frontend (Vercel)
- 👉 Use the Vercel deployment URL  https://after-midnight-gamma.vercel.app/
- Access Token True URL  https://after-midnight-gamma.vercel.app/?token=midnight-only
...
📌 Final Note
   - Some projects are built to scale. Some are built to express.
